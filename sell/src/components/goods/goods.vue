<template>
  <div class="goods">
    <div class="menu-wrapper" ref="menuWrapper">
      <ul>
        <li v-for="(item,index) in goods" class="menu-item" :class="{'current': currentIndex === index}" @click="selecMenu(index)">
          <span class="text border-1px">
            <typeIcon :iconType="item.type" :iconNumber="3"></typeIcon>{{item.name}}
          </span>
        </li>
      </ul>
    </div>
